    ...
    <div class="container mx-auto px-6 lg:px-12">
        ...
        <div class="mt-10 relative">
            ...
            <div class="swiper-wrapper">
                ...
                <!-- Navigation Arrows -->
                <div class="absolute z-50 left-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white rounded-full w-[50px] h-[50px] flex items-center justify-center cursor-pointer shadow-lg prev hover:bg-gray-700 transition-all  duration-300">
                ...
                <div class="absolute z-50 right-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white rounded-full w-[50px] h-[50px] flex items-center justify-center cursor-pointer shadow-lg next hover:bg-gray-700 transition-all duration-300">
