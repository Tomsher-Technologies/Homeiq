<div id="account-drawer" 
    ...
    <div class="p-4 flex justify-between bg-[#41b6e8] items-center border-b border-gray-200">
        ...
        <button id="close-account" 
                class="text-xl font-bold !text-white hover:text-red-500 focus:outline-none">
  ...
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18 17.94 6M18 18 6.06 6"/>
    ...
    <div class="flex items-center justify-between bg-opacity-60 w-full  border-b border-gray-300 p-6">
                        ...
                        <div class="flex flex-col">
                            <p class="text-ms tracking-wide leading-1 text-black font-bold">Hello, Anna BK </p>
                            <p class="text-thin-light-gray text-sm leading-1 text-sm tracking-wide mt-0">annabk@mail.com
                            </p>
                        ...
                        <a href="my-profile.html" class="flex flex-col">
                            <p class="text-ms tracking-wide leading-1 text-black font-bold">
                                <svg class="w-[26px] group-hover:fill-[#41b6e8]" id="fi_2356780" enable-background="new 0 0 511.984 511.984" viewBox="0 0 511.984 511.984" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                    ...
                    <div class=" w-full h-auto flex justify-start items-center  transition-all mt-5 px-6">
                        ...
                        <div class="relative py-2 grid gap-3 grid-cols-2  w-full overflow-hidden">
                            ...
                            <a href="address_book.html" class="px-3 py-6 flex flex-col items-center rounded-md border  gap-y-4 text-center hover:bg-gray-50 w-full bg-white hover:text-[#41b6e8] group">
                                <svg class="w-[30px] group-hover:fill-[#41b6e8]" id="fi_12893925" enable-background="new 0 0 64 64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="wishlist.html" class="px-3 py-4 flex flex-col items-center rounded-md border  gap-y-4 text-center hover:bg-gray-50 w-full bg-white hover:text-[#41b6e8] group">

                                <svg class="w-[30px] group-hover:fill-[#41b6e8]" id="fi_13369080" enable-background="new 0 0 100 100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="my_order.html" class="px-3 py-4 flex flex-col items-center rounded-md border  gap-y-4 text-center hover:bg-gray-50 w-full bg-white hover:text-[#41b6e8] group">


                                <svg class="w-[30px] group-hover:fill-[#41b6e8]" id="fi_6737602" enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="my_wallet.html" class="px-3 py-4 flex flex-col items-center rounded-md border  gap-y-4 text-center hover:bg-gray-50 w-full bg-white hover:text-[#41b6e8] group">


                            <svg class="w-[30px] group-hover:fill-[#41b6e8]" ca xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-person-lock" viewBox="0 0 16 16">
