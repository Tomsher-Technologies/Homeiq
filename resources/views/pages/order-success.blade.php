@extends('layouts.app')
 @section('title', 'W - HOME_IQ')
 @section('content')
 <div class="container mx-auto py-12 px-6 lg:px-12">
    <div class="bg-white rounded-lg shadow-lg p-3 lg:p-6 max-w-md mx-auto ">
       <div class="text-center">
          <svg class="w-[100px] mx-auto mb-5" version="1.1" id="fi_190411" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 507.2 507.2" style="enable-background:new 0 0 507.2 507.2;" xml:space="preserve">
             <circle style="fill:#32BA7C;" cx="253.6" cy="253.6" r="253.6"></circle>
             <path style="fill:#0AA06E;" d="M188.8,368l130.4,130.4c108-28.8,188-127.2,188-244.8c0-2.4,0-4.8,0-7.2L404.8,152L188.8,368z"></path>
             <g>
       ...
       <div class="text-center mt-6">
          <div class="flex gap-2">
            <a class="flex items-center justify-center w-full px-4 py-2.5 text-sm font-bold text-center text-[#41b6e8] border border-[#41b6e8] transition-all duration-200 hover:text-[#41b6e8]  hover:bg-[#41b6e8] " href="details.html">Track Order</a>
            <a class="flex items-center justify-center w-full px-4 py-2.5 text-sm font-bold text-white transition-all border  border-[#41b6e8] duration-200 bg-[#41b6e8]  hover:text-[#41b6e8]  hover:bg-[#41b6e8]" href="order-field.html">Continue Shopping</a>
          </div>
       </div>
    </div>
 </div>
