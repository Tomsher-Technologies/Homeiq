...
@section('content')
                                ...
                                <div class="flex flex-col w lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4 mb-5">
                                    ...
                                    @if (auth()->check())
                                        <div class="border border-gray-300 bg-gray-50 p-4 rounded-lg flex items-center justify-center flex-1">
                                            <a href="#"
                                                class="text-dark flex flex-col items-center justify-center gap-3 text-center"
    ...
    <div id="drawer-right-example"
        class="fixed top-0 right-0 z-40 h-screen p-4 overflow-y-auto transition-transform translate-x-full bg-white w-[500px] z-[999]"
        ...
        <div class="p-4 bg-gray-100  mt-3">
            <div class="mb-4 md:flex  flex-col">
                <div class="w-full mb-2">
                    ...
                    <input type="text" name="first-name"
                        class="w-full bg-gray-50 py-4 ps-6 rounded-lg border border-gray-300"
            ...
            <div class="w-full mb-4">
                ...
                <select name="country" class="w-full bg-gray-50 py-4 ps-6 rounded-lg border border-gray-300"
                    required="">
            ...
            <div class="w-full mb-4 ">
                <label class="block mb-1 font-medium text-gray-800 capitalize">State *</label>
                <select name="state" class="w-full bg-gray-50 py-4 ps-6 rounded-lg border border-gray-300"
                    required="">
        ...
        <div class="grid grid-cols-2 gap-4">
            <a href="#"
                class="flex w-full mt-3 items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 bg-[#41b6e8] py-4">Save
                address</a>
        </div>
    </div>
@endsection
